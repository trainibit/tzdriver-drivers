...
-- public.drivers foreign keys


ALTER TABLE public.drivers ADD CONSTRAINT drivers_states_fk FOREIGN KEY (id_state) REFERENCES public.states(id);
ALTER TABLE public.drivers ADD CONSTRAINT drivers_vehicles_fk FOREIGN KEY (id_vehicle) REFERENCES public.vehicles(id);
ALTER TABLE public.reviews ADD CONSTRAINT reviews_drivers_fk FOREIGN KEY (id_driver) REFERENCES public.drivers(id);
