...
CREATE TABLE public.reviews (
                                ...
                                CONSTRAINT reviews_unique_1 UNIQUE (id_trips),
                                CONSTRAINT reviews_unique_2 UNIQUE (id_user),
...
CREATE TABLE public.scores (
                               id int8 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL,
                               "uuid" uuid NOT NULL,
                               penalty_count int8 DEFAULT 0 NOT NULL,
                               updated_at timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
                               created_at timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
                               average_response_time time DEFAULT '00:00:00'::time without time zone NOT NULL,
                               canceled_trips int8 DEFAULT 0 NOT NULL,
                               completed_trips int8 DEFAULT 0 NOT NULL,
                               total_reviews int8 DEFAULT 0 NOT NULL,
                               average_reviews float4 DEFAULT 0 NOT NULL,
                               active bool DEFAULT true NOT NULL,
                               id_review int8 NULL,
                               CONSTRAINT scores_pk PRIMARY KEY (id),
                               CONSTRAINT scores_unique UNIQUE (uuid),
                               CONSTRAINT scores_reviews_fk FOREIGN KEY (id) REFERENCES public.reviews(id)
);
...
CREATE TABLE public.drivers (
                                ...
                                "uuid" uuid NOT NULL,
                                current_latitude float8 NOT NULL,
                                current_longitude float8 NOT NULL,
                                active bool DEFAULT true NOT NULL,
                                updated_at timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
                                created_at timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
                                id_vehicle int8 NOT NULL,
                                id_score int8 NOT NULL,
                                id_state int8 NOT NULL,
                                CONSTRAINT driver_pk PRIMARY KEY (id),
                                CONSTRAINT driver_unique UNIQUE (uuid),
                                CONSTRAINT drivers_scores_fk FOREIGN KEY (id_score) REFERENCES public.scores(id),
                                CONSTRAINT drivers_states_fk FOREIGN KEY (id_state) REFERENCES public.states(id),
                                CONSTRAINT drivers_vehicles_fk FOREIGN KEY (id_vehicle) REFERENCES public.vehicles(id)
);